                    ...
                    <div class="navbar-nav">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu bg-light rounded-0 rounded-bottom m-0">
                                <a href="lihat_data.php" class="dropdown-item" class="nav-item nav-link active">Data pengguna yang memberi kritik dan saran</a>
                            </div>
                        </div>
                        <a href="contact.php" class="nav-item nav-link">Kontak</a>
                    </div>
                    <div class="ms-auto d-none d-lg-block">
                        <a href="https://www.adamdev.my.id" target="_blank" class="btn btn-primary rounded-pill py-2 px-3">Layanan membangun website, klik disini</a>
                    </div>
                </div>
            </nav>
        </div>
